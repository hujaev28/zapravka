object DMS: TDMS
  ...
  object s_client: TZQuery
    ...
    object s_clientreklama: TIntegerField
      FieldName = 'reklama'
    end
    object s_clienthajm: TIntegerField
      FieldName = 'hajm'
    end
    object s_clientfaoliyat: TIntegerField
      FieldName = 'faoliyat'
    end
    object s_clientulg: TSmallintField
      FieldName = 'ulg'
    end
    object s_clientchakana: TSmallintField
      FieldName = 'chakana'
    end
    object s_clientkridit: TSmallintField
      FieldName = 'kridit'
    end
    object s_clientdatawait: TDateTimeField
      FieldName = 'datawait'
    end
    object s_clientizoh: TMemoField
      FieldName = 'izoh'
      BlobType = ftMemo
    end
    object s_clientcontact: TSmallintField
      FieldName = 'contact'
    end
    object s_clientwifi: TSmallintField
      FieldName = 'wifi'
    end
    object s_clientsert: TIntegerField
      FieldName = 'sert'
    end
    object s_clientlastqr: TIntegerField
      FieldName = 'lastqr'
    end
    object s_clientqoldiq: TIntegerField
      FieldName = 'qoldiq'
    end
    object s_clienttarozi: TIntegerField
      FieldName = 'tarozi'
    end
    object s_clientzavod: TIntegerField
      FieldName = 'zavod'
    end
    object s_clientmxik: TSmallintField
      FieldName = 'mxik'
    end
    object s_clientshtrix: TSmallintField
      FieldName = 'shtrix'
    end
    object s_clientfoizli: TSmallintField
      FieldName = 'foizli'
    end
    object s_clientsotishtokirim: TSmallintField
      FieldName = 'sotishtokirim'
    end
  end
  ...
  object s_xodim: TZQuery
    ...
    object s_xodimkirim: TIntegerField
      FieldName = 'kirim'
    end
    object s_xodiminventar: TIntegerField
      FieldName = 'inventar'
    end
    object s_xodimstatus: TSmallintField
      FieldName = 'status'
      Required = True
    end
    object s_xodimflag: TIntegerField
      FieldName = 'flag'
    end
  ...
  object link: TZQuery
    Connection = lbd
    SQL.Strings = (
      'SELECT * from asos_slave where del_flag=1')
    Params = <>
  ...
  object s_tovar: TZQuery
    ...
    object s_tovarholat: TIntegerField
      FieldName = 'holat'
    end
    object s_tovarseriya: TIntegerField
      FieldName = 'seriya'
    end
    object s_tovartkol: TIntegerField
      FieldName = 'tkol'
    end
    object s_tovartkol_in: TIntegerField
      FieldName = 'tkol_in'
    end
    object s_tovarinvkol: TIntegerField
      FieldName = 'invkol'
    end
    object s_tovarinvkolin: TIntegerField
      FieldName = 'invkolin'
    end
    object s_tovarsennik: TIntegerField
      FieldName = 'sennik'
    end
    object s_tovarinvsana: TDateTimeField
      FieldName = 'invsana'
    end
    ...
    object s_tovartarozi: TFloatField
      FieldName = 'tarozi'
    end
    object s_tovarbonus: TStringField
      FieldName = 'bonus'
      Size = 1
    end
    object s_tovarmxik: TStringField
      FieldName = 'mxik'
      Size = 200
    end
    object s_tovarizm2: TIntegerField
      FieldName = 'izm2'
    end
    object s_tovarizmnom: TStringField
      FieldName = 'izmnom'
      Size = 250
    end
    object s_tovarnds: TFloatField
      FieldName = 'nds'
    end
    object s_tovarshifr: TStringField
      FieldName = 'shifr'
      Size = 5
    end
    object s_tovarqoldiq: TStringField
      FieldName = 'qoldiq'
      Size = 1
    end
    object s_tovarfoiz: TFloatField
      FieldName = 'foiz'
    end
    object s_tovarson: TFloatField
      FieldName = 'son'
    end
    object s_tovarparametr: TMemoField
      FieldName = 'parametr'
      BlobType = ftMemo
    end
  end
  ...
  object asos: TZQuery
    Connection = lbd
    AfterScroll = asosAfterScroll
    BeforePost = asosBeforePost
    ...
    object asosinv_id: TIntegerField
      FieldName = 'inv_id'
    end
    object asosd_id: TIntegerField
      FieldName = 'd_id'
    end
    object asossum_click: TFloatField
      FieldName = 'sum_click'
    end
    object asossum_click_ch: TFloatField
      FieldName = 'sum_click_ch'
    end
    object asoscheg_c: TFloatField
      FieldName = 'cheg_c'
    end
    object asosc_id: TIntegerField
      FieldName = 'c_id'
    end
    object asossrok: TDateField
      FieldName = 'srok'
    end
    object asoss_inv: TStringField
      FieldKind = fkLookup
      FieldName = 's_inv'
      LookupDataSet = ts_inv
      LookupKeyFields = 'id'
      LookupResultField = 'nom'
      KeyFields = 'inv_id'
      Size = 150
    ...
    object asosqarz_s_ost: TFloatField
      FieldName = 'qarz_s_ost'
    end
    object asosqarz_d_ost: TFloatField
      FieldName = 'qarz_d_ost'
    end
    object asosbajar: TIntegerField
      FieldName = 'bajar'
    end
    object asosbajarfio: TStringField
      FieldKind = fkLookup
      FieldName = 'bajarfio'
      LookupDataSet = s_xodim
      LookupKeyFields = 'id'
    ...
    object asosbajartel: TStringField
      FieldKind = fkLookup
      FieldName = 'bajartel'
      LookupDataSet = s_xodim
      LookupKeyFields = 'id'
    ...
    object asoss_bajar: TStringField
      FieldKind = fkLookup
      FieldName = 's_bajar'
      LookupDataSet = s_user
      LookupKeyFields = 'id'
    ...
    object asosxizmat_foiz: TIntegerField
      FieldName = 'xizmat_foiz'
    end
    object asoscheg: TFloatField
      FieldName = 'cheg'
    end
    object asoswoywo_bill_type: TSmallintField
      FieldName = 'woywo_bill_type'
    end
    object asosbonus: TFloatField
      FieldName = 'bonus'
    end
    object asosbonusno: TFloatField
      FieldName = 'bonusno'
    end
    object asoszet_id: TIntegerField
      FieldName = 'zet_id'
    end
    object asosvalyuta_turi: TIntegerField
      FieldName = 'valyuta_turi'
    end
    object asoshtelsms1: TStringField
      FieldKind = fkLookup
      FieldName = 'htel'
      LookupDataSet = haridorlar
      LookupKeyFields = 'id'
      LookupResultField = 'telsms1'
      KeyFields = 'h_id'
      Size = 100
      Lookup = True
    end
    object asoshfio: TStringField
      FieldKind = fkLookup
      FieldName = 'hfio'
      LookupDataSet = haridorlar
      LookupKeyFields = 'id'
  ...
  object asos_slave: TZQuery
    ...
    object asos_slavesot: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sot'
      Calculated = True
    end
    object asos_slavesot_all: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sot_all'
      Calculated = True
    end
    object asos_slavesot_in: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sot_in'
      Calculated = True
    end
    object asos_slavesot_in_all: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sot_in_all'
      Calculated = True
    end
    object asos_slavesot_jami: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sot_jami'
      Calculated = True
    end
    object asos_slaveqrkod: TIntegerField
      FieldName = 'qrkod'
    end
    object asos_slavekol_all: TFloatField
      FieldName = 'kol_all'
    end
    object asos_slaveeni: TFloatField
      FieldName = 'eni'
    end
    object asos_slavebuyi: TFloatField
      FieldName = 'buyi'
    end
    object asos_slavekvadrat: TFloatField
      FieldName = 'kvadrat'
    end
    object asos_slavekvsoni: TIntegerField
      FieldName = 'kvsoni'
    end
    object asos_slavekvjami: TFloatField
      FieldName = 'kvjami'
    end
  ...
  object s_diler: TZQuery
    ...
    object s_dilerchat_id: TLargeintField
      FieldName = 'chat_id'
    end
    object s_dilerphone_number: TStringField
      FieldName = 'phone_number'
      Size = 255
    end
    object s_dilerclient_id: TIntegerField
      FieldName = 'client_id'
    end
  end
  ...
  object qoldiq: TZQuery
    ...
    object qoldiqol: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ol'
      Calculated = True
    end
    object qoldiqol_in: TFloatField
      FieldKind = fkCalculated
      FieldName = 'ol_in'
      Calculated = True
    end
    object qoldiqol_all: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ol_all'
      Calculated = True
    end
    object qoldiqols: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ols'
      Calculated = True
    end
    object qoldiqols_in: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ols_in'
      Calculated = True
    end
    object qoldiqsot: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'sot'
      Calculated = True
    end
    object qoldiqsot_in: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'sot_in'
      Calculated = True
    end
    object qoldiqsot_all: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'sot_all'
      Calculated = True
    end
    object qoldiqkol_in: TIntegerField
      FieldName = 'kol_in'
    end
    object qoldiqqrkod: TIntegerField
      FieldName = 'qrkod'
    end
    object qoldiqs_dollar: TIntegerField
      FieldKind = fkLookup
      FieldName = 's_dollar'
      LookupDataSet = asos_qoldiq
      LookupKeyFields = 'id'
      LookupResultField = 'dollar'
      KeyFields = 'asos_id'
      Lookup = True
    end
  end
  ...
  object s_t_all: TZQuery
    ...
    object s_t_allqoldiq: TStringField
      FieldName = 'qoldiq'
      Size = 1
    end
    object s_t_allholat: TIntegerField
      FieldName = 'holat'
    end
  end
  ...
  object client_edit: TZQuery
    ...
    object client_editshtrix: TSmallintField
      FieldName = 'shtrix'
    end
    object client_editfoizli: TSmallintField
      FieldName = 'foizli'
    end
    object client_editsotishtokirim: TSmallintField
      FieldName = 'sotishtokirim'
    end
  end
  ...
  object k_asos: TZQuery
    ...
    object k_asosinv_id: TIntegerField
      FieldName = 'inv_id'
    end
    object k_asoss_inv: TStringField
      FieldKind = fkLookup
      FieldName = 's_inv'
      LookupDataSet = ts_inv
      LookupKeyFields = 'id'
    ...
    object k_asoscheg: TFloatField
      FieldName = 'cheg'
    end
    object k_asoscheg_c: TFloatField
      FieldName = 'cheg_c'
    end
    object k_asosbajar: TIntegerField
      FieldName = 'bajar'
    end
    object k_asosbajardi: TStringField
      FieldKind = fkLookup
      FieldName = 'bajardi'
      LookupDataSet = s_xodim
      LookupKeyFields = 'id'
    ...
    object k_asosbonus: TFloatField
      FieldName = 'bonus'
    end
    object k_asosxizmat_foiz: TIntegerField
      FieldName = 'xizmat_foiz'
    end
    object k_asossum_click_ch: TFloatField
      FieldName = 'sum_click_ch'
    end
    object k_asosbonusno: TFloatField
      FieldName = 'bonusno'
    end
  end
  ...
  object k_slave: TZQuery
    ...
    object k_slaveol: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ol'
      Calculated = True
    end
    object k_slaveol_all: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ol_all'
      Calculated = True
    end
    object k_slavesot: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'sot'
      Calculated = True
    end
    object k_slavesot_all: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'sot_all'
      Calculated = True
    end
    object k_slaveqrkod: TIntegerField
      FieldName = 'qrkod'
    end
  end
  ...
  object qoldiq_sklad: TZQuery
    ...
    object qoldiq_skladqrkod: TIntegerField
      FieldName = 'qrkod'
    end
    object qoldiq_skladkol: TIntegerField
      FieldName = 'kol'
    end
    object qoldiq_skladkol_in: TIntegerField
      FieldName = 'kol_in'
    end
  end
  ...
  object s_haridor: TZQuery
    ...
    object s_haridorqarz_sum: TFloatField
      FieldName = 'qarz_sum'
    end
    object s_haridorqarz_d: TFloatField
      FieldName = 'qarz_d'
    end
    object s_haridorlast_qarz: TDateField
      FieldName = 'last_qarz'
    end
    object s_haridorlast_asos: TDateField
      FieldName = 'last_asos'
    end
    object s_haridorlast_pl: TDateField
      FieldName = 'last_pl'
    end
  end
  ...
  object s_kat: TZQuery
    Connection = lbd
    OnNewRecord = s_katNewRecord
    SQL.Strings = (
      'SELECT * FROM s_kat where client_id=:id')
    Params = <
      item
        DataType = ftUnknown
        Name = 'id'
    ...
    object s_katid: TIntegerField
      FieldName = 'id'
      Required = True
    end
    object s_katnom: TStringField
      FieldName = 'nom'
      Required = True
      Size = 250
    end
    object s_katclient_id: TIntegerField
      FieldName = 'client_id'
      Required = True
    end
    object s_katkassa: TIntegerField
      FieldName = 'kassa'
    end
  end
  ...
  object s_brend: TZQuery
    Connection = lbd
    OnNewRecord = s_brendNewRecord
    SQL.Strings = (
      'SELECT * FROM s_brend  where client_id=:id')
    Params = <
      item
        DataType = ftUnknown
        Name = 'id'
    ...
    object s_brendclient_id: TIntegerField
      FieldName = 'client_id'
      Required = True
    end
  end
  ...
  object tpl: TZQuery
    ...
    object tplsrok: TDateField
      FieldName = 'srok'
    end
    object tplinv_id: TIntegerField
      FieldName = 'inv_id'
    end
    object tpls_inv: TStringField
      FieldKind = fkLookup
      FieldName = 's_inv'
      LookupDataSet = ts_inv
      LookupKeyFields = 'id'
    ...
    object tplasos_id: TIntegerField
      FieldName = 'asos_id'
    end
    object tplkonv: TIntegerField
      FieldName = 'konv'
    end
    object tplvaqt: TDateTimeField
      FieldName = 'vaqt'
    end
    object tplzet_id: TIntegerField
      FieldName = 'zet_id'
    end
  end
  ...
  object oraliq: TZQuery
    Connection = lbd
    SQL.Strings = (
      'select * from oraliq where sf_id=:id ')
    Params = <
      item
        DataType = ftInteger
        Name = 'id'
  ...
  object s_kurs: TZQuery
    Connection = lbd
    OnNewRecord = s_kursNewRecord
    SQL.Strings = (
      'SELECT * FROM s_kurs where client_id=:id order by id')
    Params = <
      item
        DataType = ftUnknown
        Name = 'id'
  ...
  object s_mobil: TZQuery
    Connection = lbd
    SQL.Strings = (
      'select * from s_mobil order by qavat,nn')
    Params = <>
    Left = 937
    Top = 237
  end
  ...
  object k_slave1: TZQuery
    Connection = lbd
    OnCalcFields = k_slave1CalcFields
    ...
    object k_slave1sot: TFloatField
      AutoGenerateValue = arDefault
      FieldKind = fkCalculated
      FieldName = 'sot'
      Calculated = True
    end
    object k_slave1sot_all: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sot_all'
      Calculated = True
    end
    object k_slave1ol: TFloatField
      FieldKind = fkCalculated
      FieldName = 'ol'
      Calculated = True
    end
    object k_slave1ol_all: TFloatField
      FieldKind = fkCalculated
      FieldName = 'ol_all'
      Calculated = True
    end
    object k_slave1ol_in: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ol_in'
      Calculated = True
    end
    object k_slave1ols: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ols'
      currency = False
      Calculated = True
    end
    object k_slave1ols_in: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ols_in'
      Calculated = True
    end
    object k_slave1ols_all: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ols_all'
      Calculated = True
    end
    object k_slave1sot_in: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'sot_in'
      Calculated = True
    end
    object k_slave1kol_all: TFloatField
      FieldName = 'kol_all'
    end
  end
  ...
  object ts_inv: TZQuery
    Connection = lbd
    SQL.Strings = (
      'SELECT * FROM s_inv where del_flag=1 order by id')
    Params = <>
    Left = 665
    Top = 240
  end
  ...
  object tzet: TZQuery
    Connection = lbd
    SQL.Strings = (
      'select * from zet order by id')
    Params = <>
    Left = 1001
    Top = 237
  end
  object Dzet: TDataSource
    DataSet = tzet
    Left = 1001
    Top = 285
  end
  ...
  object ttasnif: TZQuery
    ...
    Left = 50
    Top = 353
    object ttasnifid: TIntegerField
      FieldName = 'id'
      Required = True
    end
    object ttasnifmxik: TStringField
      FieldName = 'mxik'
      Size = 17
    end
    object ttasnifnom: TStringField
      FieldName = 'nom'
      Size = 500
    end
    object ttasnifshtrix: TStringField
      FieldName = 'shtrix'
      Size = 13
    end
    object ttasnifactive: TSmallintField
      FieldName = 'active'
    end
    object ttasniftovar_id: TIntegerField
      FieldName = 'tovar_id'
    end
    object ttasnifbrend: TStringField
      FieldName = 'brend'
      Size = 200
    end
    object ttasnifatribut: TStringField
      FieldName = 'atribut'
      Size = 200
    end
    object ttasnifqadoq: TStringField
      FieldName = 'qadoq'
      Size = 200
    end
    object ttasnifizm_group: TStringField
      FieldName = 'izm_group'
      Size = 200
    end
    object ttasnifizm: TStringField
      FieldName = 'izm'
      Size = 200
    end
    object ttasnifizm_group1: TStringField
      FieldName = 'izm_group1'
      Size = 200
    end
    object ttasnifizm1: TStringField
      FieldName = 'izm1'
      Size = 200
    end
    object ttasnifimtiyoz: TStringField
      FieldName = 'imtiyoz'
      Size = 200
    end
  end
  object Dshtrix: TDataSource
    DataSet = tshtrix
    Left = 106
    Top = 414
  end
  object tshtrix: TZQuery
    Connection = lbd
    SQL.Strings = (
      'SELECT * FROM shtrix where tovar_id=:id')
    Params = <
      item
        DataType = ftUnknown
        Name = 'id'
  ...
  object Dobmor: TDataSource
    DataSet = tshtrix
    Left = 162
    Top = 414
  end
  object shtrix: TZQuery
    Connection = lbd
    SQL.Strings = (
      'SELECT * FROM shtrix ')
    Params = <>
  ...
  object haridorlar: TZQuery
    Connection = lbd
    SQL.Strings = (
      
        'SELECT id,nom,telsms1 FROM s_haridor where del_flag=1 order by n' +
        'om')
    Params = <>
    Left = 306
    Top = 353
  end
  object Dharidorlar: TDataSource
    DataSet = haridorlar
    Left = 306
    Top = 414
  end
