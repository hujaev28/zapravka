...
type
  TDMS = class(TDataModule)
    ...
    asosinv_id: TIntegerField;
    tplsrok: TDateField;
    tplinv_id: TIntegerField;
    ts_inv: TZQuery;
    Ds_inv: TDataSource;
    asosd_id: TIntegerField;
    asossum_click: TFloatField;
    asossum_click_ch: TFloatField;
    asoscheg_c: TFloatField;
    asosc_id: TIntegerField;
    tpls_inv: TStringField;
    k_asosinv_id: TIntegerField;
    k_asoss_inv: TStringField;
    asossrok: TDateField;
    asoss_inv: TStringField;
    s_haridorqarz_sum: TFloatField;
    s_haridorqarz_d: TFloatField;
    s_haridorlast_qarz: TDateField;
    s_haridorlast_asos: TDateField;
    s_haridorlast_pl: TDateField;
    tplasos_id: TIntegerField;
    tplkonv: TIntegerField;
    s_tovarholat: TIntegerField;
    asosqarz_s_ost: TFloatField;
    asosqarz_d_ost: TFloatField;
    s_clientreklama: TIntegerField;
    s_clienthajm: TIntegerField;
    s_clientfaoliyat: TIntegerField;
    s_clientulg: TSmallintField;
    s_clientchakana: TSmallintField;
    s_clientkridit: TSmallintField;
    s_clientdatawait: TDateTimeField;
    s_clientizoh: TMemoField;
    s_clientcontact: TSmallintField;
    s_clientwifi: TSmallintField;
    s_clientsert: TIntegerField;
    asos_slavesot: TFloatField;
    asos_slavesot_all: TFloatField;
    asos_slavesot_in: TFloatField;
    asos_slavesot_in_all: TFloatField;
    asos_slavesot_jami: TFloatField;
    k_slave1sot: TFloatField;
    k_slave1sot_all: TFloatField;
    k_slave1ol: TFloatField;
    k_slave1ol_all: TFloatField;
    k_slaveol: TCurrencyField;
    k_slaveol_all: TCurrencyField;
    k_slavesot: TCurrencyField;
    k_slavesot_all: TCurrencyField;
    s_dilerchat_id: TLargeintField;
    s_dilerphone_number: TStringField;
    s_dilerclient_id: TIntegerField;
    s_brendclient_id: TIntegerField;
    s_katid: TIntegerField;
    s_katnom: TStringField;
    s_katclient_id: TIntegerField;
    k_asoscheg: TFloatField;
    k_asoscheg_c: TFloatField;
    s_katkassa: TIntegerField;
    s_clientlastqr: TIntegerField;
    s_clientqoldiq: TIntegerField;
    s_xodimkirim: TIntegerField;
    asosbajar: TIntegerField;
    k_asosbajar: TIntegerField;
    k_asosbajardi: TStringField;
    asosbajarfio: TStringField;
    asosbajartel: TStringField;
    s_tovarseriya: TIntegerField;
    s_tovartkol: TIntegerField;
    s_tovartkol_in: TIntegerField;
    s_tovarinvkol: TIntegerField;
    s_tovarinvkolin: TIntegerField;
    s_tovarsennik: TIntegerField;
    s_tovarinvsana: TDateTimeField;
    s_xodiminventar: TIntegerField;
    qoldiqol: TCurrencyField;
    qoldiqol_in: TFloatField;
    qoldiqol_all: TCurrencyField;
    qoldiqols: TCurrencyField;
    qoldiqols_in: TCurrencyField;
    qoldiqsot: TCurrencyField;
    qoldiqsot_in: TCurrencyField;
    qoldiqsot_all: TCurrencyField;
    k_slave1ol_in: TCurrencyField;
    k_slave1ols: TCurrencyField;
    k_slave1ols_in: TCurrencyField;
    k_slave1ols_all: TCurrencyField;
    k_slave1sot_in: TCurrencyField;
    asoss_bajar: TStringField;
    k_asosbonus: TFloatField;
    s_xodimstatus: TSmallintField;
    s_xodimflag: TIntegerField;
    asosxizmat_foiz: TIntegerField;
    asos_slaveqrkod: TIntegerField;
    qoldiqkol_in: TIntegerField;
    qoldiq_skladqrkod: TIntegerField;
    qoldiq_skladkol: TIntegerField;
    qoldiq_skladkol_in: TIntegerField;
    qoldiqqrkod: TIntegerField;
    k_asosxizmat_foiz: TIntegerField;
    k_slaveqrkod: TIntegerField;
    s_tovarkol_in: TSmallintField;
    s_t_allkol_in: TSmallintField;
    s_clienttarozi: TIntegerField;
    s_tovartarozi: TFloatField;
    k_asossum_click_ch: TFloatField;
    s_tovarbonus: TStringField;
    k_asosbonusno: TFloatField;
    asos_slavekol_all: TFloatField;
    asos_slaveeni: TFloatField;
    asos_slavebuyi: TFloatField;
    asos_slavekvadrat: TFloatField;
    asos_slavekvsoni: TIntegerField;
    asos_slavekvjami: TFloatField;
    asos_slaveopt2: TFloatField;
    tzet: TZQuery;
    Dzet: TDataSource;
    tplvaqt: TDateTimeField;
    tplzet_id: TIntegerField;
    asoscheg: TFloatField;
    asoswoywo_bill_type: TSmallintField;
    asosbonus: TFloatField;
    asosbonusno: TFloatField;
    asoszet_id: TIntegerField;
    s_clientzavod: TIntegerField;
    s_xodimsite_address: TStringField;
    s_tovarmxik: TStringField;
    s_tovarizm2: TIntegerField;
    s_tovarizmnom: TStringField;
    s_tovarnds: TFloatField;
    s_clientmxik: TSmallintField;
    Dtasnif: TDataSource;
    ttasnif: TZQuery;
    ttasnifid: TIntegerField;
    ttasnifmxik: TStringField;
    ttasnifnom: TStringField;
    ttasnifshtrix: TStringField;
    ttasnifactive: TSmallintField;
    ttasniftovar_id: TIntegerField;
    ttasnifbrend: TStringField;
    ttasnifatribut: TStringField;
    ttasnifqadoq: TStringField;
    ttasnifizm_group: TStringField;
    ttasnifizm: TStringField;
    ttasnifizm_group1: TStringField;
    ttasnifizm1: TStringField;
    ttasnifimtiyoz: TStringField;
    Dshtrix: TDataSource;
    tshtrix: TZQuery;
    tombor: TZQuery;
    Dobmor: TDataSource;
    s_tovarshifr: TStringField;
    shtrix: TZQuery;
    s_tovarqoldiq: TStringField;
    s_t_allqoldiq: TStringField;
    s_t_allholat: TIntegerField;
    s_clientshtrix: TSmallintField;
    s_clientfoizli: TSmallintField;
    s_clientsotishtokirim: TSmallintField;
    client_editshtrix: TSmallintField;
    client_editfoizli: TSmallintField;
    client_editsotishtokirim: TSmallintField;
    asosvalyuta_turi: TIntegerField;
    k_slave1kol_all: TFloatField;
    s_tovarfoiz: TFloatField;
    s_tovarson: TFloatField;
    qoldiqs_dollar: TIntegerField;
    s_tovarparametr: TMemoField;
    asoshtelsms1: TStringField;
    haridorlar: TZQuery;
    ...
    procedure k_slave1s_senaGetText(Sender: TField; var Text: String;
      DisplayText: Boolean);
    procedure k_slave1CalcFields(DataSet: TDataSet);
    procedure s_katNewRecord(DataSet: TDataSet);
    procedure s_brendNewRecord(DataSet: TDataSet);
    procedure s_kursNewRecord(DataSet: TDataSet);
...
var
  DMS: TDMS;
  haridor_id,diler_id,forma,change,tolov_id:string;
implementation

uses  fs_ostatka, fs_tovar_edit, fshartnoma, fkirim, Variants, Math;
...
begin
  ...
  if (dms.s_tovardel_flag.Value<>dms.s_tovardel_flag.OldValue) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('nima').AsString:='s_tovar delete';
  dms.protizm.fieldbyname('vid').AsInteger:=1;
  dms.protizm.fieldbyname('old_value').AsString:=dms.s_tovardel_flag.OldValue;
  ...
  dms.protizm.fieldbyname('new_value').AsString:=dms.s_tovardel_flag.AsString;
  ...
  if (dms.s_tovar.FieldByName('sena').OldValue<>dms.s_tovarsena.Value) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=1;
  dms.protizm.fieldbyname('nima').AsString:='s_tovar sena';
  if dms.s_tovarsena.OldValue=Null then
    dms.protizm.fieldbyname('old_value').AsString:='Pustoy'
  else
    dms.protizm.fieldbyname('old_value').AsString:=dms.s_tovarsena.OldValue;
  if dms.s_tovaruser_id.AsInteger>0 then
  dms.protizm.fieldbyname('old_adminnom').AsVariant:=dms.s_tovars_user.Value
  else
  dms.protizm.fieldbyname('old_adminnom').AsVariant:=dms.s_tovars_client.Value;
  dms.protizm.fieldbyname('old_changedate').AsVariant:=dms.s_tovarchangedate.Value;
  dms.protizm.fieldbyname('new_value').AsString:=dms.s_tovarsena.AsString;
  dms.protizm.fieldbyname('subid').AsInteger:=dms.s_tovarid.AsInteger;
  dms.protizm.fieldbyname('new_adminnom').AsString:=dms.s_user.FieldByName('username').AsString;
  dms.protizm.fieldbyname('new_changedate').AsVariant:=dms.setup.fieldbyname('vaqt').Value;
  if ((dms.s_tovarsena.OldValue=Null) and (dms.s_tovarsena.AsInteger=0)) then
    DMS.protizm.Cancel
  else
    DMS.protizm.Post;
  end;
...
begin
  if ((s_client.Active = false) and (dms.s_user.FieldByName('status').AsString<>'3')) or (dms.s_user.FieldByName('id').AsString='') then exit;
  dms.setup.Refresh;
  dms.s_clientuser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
...
begin
  ...
  dms.asos_qoldiqclient_id.value:=StrToInt(dms.s_user.FieldByName('id').AsString);
...
begin
  if (client_edit.Active = false) and (dms.s_user.FieldByName('status').AsString<>'3') then exit;
  dms.setup.Refresh;
  dms.client_edituser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
...
var  nima:string;
begin
  if dms.asoschangedate.AsVariant=null then exit;
  dms.setup.Refresh;
  if dms.asosmobil.AsInteger=0 then
  dms.asos_slaveuser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);

  dms.asos_slavechangedate.AsDateTime:=dms.setupvaqt.AsDateTime;

  If dms.asos_slave.State=dsInsert then begin
    exit;
  end;
  if (dms.asos_slavedel_flag.AsVariant<>dms.asos_slavedel_flag.OldValue) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('nima').AsString:='slave delete';
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('old_value').AsString:=dms.asos_slavedel_flag.OldValue;
  ...
  if (dms.asos_slavesotish.AsVariant=dms.asos_slavesotish.OldValue) and (dms.asos_slavekol_in.AsVariant=0) and (dms.asos_slavekol_in.OldValue=0) and (dms.asos_slavekol.AsVariant=1) and (dms.asos_slavekol.OldValue=0) then exit;
  if (dms.asos_slavekol.AsVariant<>dms.asos_slavekol.OldValue) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='slave kol';
  dms.protizm.fieldbyname('old_value').AsString:=dms.asos_slavekol.OldValue;
  dms.protizm.fieldbyname('old_adminnom').AsVariant:=dms.asos_slaveuser_id.AsString;
  dms.protizm.fieldbyname('old_changedate').AsVariant:=dms.asos_slavechangedate.AsVariant;
  dms.protizm.fieldbyname('new_value').AsString:=dms.asos_slavekol.AsString;
  dms.protizm.fieldbyname('subid').AsInteger:=dms.asos_slaveid.AsInteger;
  dms.protizm.fieldbyname('new_adminnom').AsString:=dms.s_user.FieldByName('username').AsString;
  dms.protizm.fieldbyname('new_changedate').AsVariant:=dms.setup.fieldbyname('vaqt').Value;
  DMS.protizm.Post;
  end;
  if (dms.asos_slavekol_in.AsVariant<>dms.asos_slavekol_in.OldValue) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='slave kol_in';
  dms.protizm.fieldbyname('old_value').AsString:=dms.asos_slavekol_in.OldValue;
  dms.protizm.fieldbyname('old_adminnom').AsVariant:=dms.asos_slaveuser_id.AsString;
  dms.protizm.fieldbyname('old_changedate').AsVariant:=dms.asos_slavechangedate.AsVariant;
  dms.protizm.fieldbyname('new_value').AsString:=dms.asos_slavekol_in.AsString;
  dms.protizm.fieldbyname('subid').AsInteger:=dms.asos_slaveid.AsInteger;
  dms.protizm.fieldbyname('new_adminnom').AsString:=dms.s_user.FieldByName('username').AsString;
  dms.protizm.fieldbyname('new_changedate').AsVariant:=dms.setup.fieldbyname('vaqt').Value;
  DMS.protizm.Post;
  end;
  if (dms.asos_slavesotish.AsVariant<>dms.asos_slavesotish.OldValue) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='slave sotish';
  dms.protizm.fieldbyname('old_value').AsString:=dms.asos_slavesotish.OldValue;
  dms.protizm.fieldbyname('old_adminnom').AsVariant:=dms.asos_slaveuser_id.AsString;
  dms.protizm.fieldbyname('old_changedate').AsVariant:=dms.asos_slavechangedate.AsVariant;
  dms.protizm.fieldbyname('new_value').AsString:=dms.asos_slavesotish.AsString;
  dms.protizm.fieldbyname('subid').AsInteger:=dms.asos_slaveid.AsInteger;
  dms.protizm.fieldbyname('new_adminnom').AsString:=dms.s_user.FieldByName('username').AsString;
  dms.protizm.fieldbyname('new_changedate').AsVariant:=dms.setup.fieldbyname('vaqt').Value;
  DMS.protizm.Post;
  end;
  if (dms.asos_slavesotish_d.AsVariant<>dms.asos_slavesotish_d.OldValue) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='slave sotish_d';
  dms.protizm.fieldbyname('old_value').AsString:=dms.asos_slavesotish_d.OldValue;
  dms.protizm.fieldbyname('old_adminnom').AsVariant:=dms.asos_slaveuser_id.AsString;
  dms.protizm.fieldbyname('old_changedate').AsVariant:=dms.asos_slavechangedate.AsVariant;
  dms.protizm.fieldbyname('new_value').AsString:=dms.asos_slavesotish_d.AsString;
  dms.protizm.fieldbyname('subid').AsInteger:=dms.asos_slaveid.AsInteger;
  dms.protizm.fieldbyname('new_adminnom').AsString:=dms.s_user.FieldByName('username').AsString;
  dms.protizm.fieldbyname('new_changedate').AsVariant:=dms.setup.fieldbyname('vaqt').Value;
  DMS.protizm.Post;
...
begin
  ...
  dms.s_x_tur.FieldByName('client_id').AsInteger:=dms.s_clientid.AsInteger;
  dms.s_x_tur.FieldByName('user_id').AsInteger:=dms.s_clientid.AsInteger;
end;
...
begin
  dms.shartnomauser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
  dms.shartnomaclient_id.AsInteger:=StrToInt(dms.s_user.FieldByName('client_id').AsString);
end;

procedure TDMS.s_zavodNewRecord(DataSet: TDataSet);
begin
  dms.s_zavod.FieldByName('client_id').AsInteger:=StrToInt(dms.s_user.FieldByName('client_id').AsString);
  dms.s_zavod.FieldByName('user_id').AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);

end;

procedure TDMS.s_kassaNewRecord(DataSet: TDataSet);
begin
  dms.s_kassauser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
  dms.s_kassaclient_id.AsInteger:=StrToInt(dms.s_user.FieldByName('client_id').AsString);
end;

procedure TDMS.s_xodimNewRecord(DataSet: TDataSet);
begin
  dms.s_xodimclient_id.AsInteger:=StrToInt(dms.s_user.FieldByName('client_id').AsString);
  dms.s_xodimsite_address.AsString:='';
...
begin
  ...
  dms.asosxodim_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
  dms.asosuser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
  dms.asosclient_id.AsInteger:=StrToInt(dms.s_user.FieldByName('client_id').AsString);
end;
...
begin
  tpluser_id.AsInteger:=StrToInt(dms.s_user.FieldByName('id').AsString);
...
procedure TDMS.k_slave1CalcFields(DataSet: TDataSet);
begin
  if dms.k_asosdollar.AsInteger>0 then begin
    dms.k_slave1ol.AsFloat:=dms.k_slave1sena_d.AsFloat;
    dms.k_slave1ol_in.AsFloat:=dms.k_slave1sena_in_d.AsFloat;
    dms.k_slave1ols.AsFloat:=dms.k_slave1kol.AsInteger*dms.k_slave1sena_d.AsFloat;
    dms.k_slave1ols_in.AsFloat:=dms.k_slave1kol_in.AsInteger*dms.k_slave1sena_in_d.AsFloat;
    dms.k_slave1ols_all.AsFloat:=dms.k_slave1kol.AsInteger*dms.k_slave1sena_d.AsFloat+dms.k_slave1kol_in.AsInteger*dms.k_slave1sena_in_d.AsFloat;
    dms.k_slave1sot.AsFloat:=dms.k_slave1sotish_d.AsFloat;
    dms.k_slave1sot_in.AsFloat:=dms.k_slave1sotish_in_d.AsFloat;
    dms.k_slave1sot_all.AsFloat:=dms.k_slave1kol.AsInteger*dms.k_slave1sotish_d.AsFloat+dms.k_slave1kol_in.AsInteger*dms.k_slave1sotish_in_d.AsFloat;
  end
  else
  begin
    dms.k_slave1ol.AsFloat:=dms.k_slave1sena.AsFloat;
    dms.k_slave1ol_in.AsFloat:=dms.k_slave1sena_in.AsFloat;
    dms.k_slave1ols.AsFloat:=dms.k_slave1kol.AsInteger*dms.k_slave1sena.AsFloat;
    dms.k_slave1ols_in.AsFloat:=dms.k_slave1kol_in.AsInteger*dms.k_slave1sena_in.AsFloat;
    dms.k_slave1ols_all.AsFloat:=dms.k_slave1kol.AsInteger*dms.k_slave1sena.AsFloat+dms.k_slave1kol_in.AsInteger*dms.k_slave1sena_in.AsFloat;
    dms.k_slave1sot.AsFloat:=dms.k_slave1sotish.AsFloat;
    dms.k_slave1sot_in.AsFloat:=dms.k_slave1sotish_in.AsFloat;
    dms.k_slave1sot_all.AsFloat:=dms.k_slave1kol.AsInteger*dms.k_slave1sotish.AsFloat+dms.k_slave1kol_in.AsInteger*dms.k_slave1sotish_in.AsFloat;
  end;
end;

procedure TDMS.s_katNewRecord(DataSet: TDataSet);
begin
 s_kat.FieldByName('client_id').AsInteger:=s_clientid.AsInteger;
end;

procedure TDMS.s_brendNewRecord(DataSet: TDataSet);
begin
  s_brend.FieldByName('client_id').AsInteger:=s_clientid.AsInteger;
end;

procedure TDMS.s_kursNewRecord(DataSet: TDataSet);
begin
 s_kurs.FieldByName('client_id').AsInteger:=s_clientid.AsInteger;
 s_kurs.FieldByName('user_id').AsInteger:=s_user.fieldbyname('id').AsInteger;
end;

procedure TDMS.qoldiqCalcFields(DataSet: TDataSet);
begin
  if (dms.asos_qoldiqdollar.AsInteger>0) then begin
    dms.qoldiqol.AsFloat:=dms.qoldiqsena_d.AsFloat;
    dms.qoldiqol_in.AsFloat:=dms.qoldiqsena_in_d.AsFloat;
    dms.qoldiqols.AsFloat:=dms.qoldiqkol.AsFloat*dms.qoldiqsena_d.AsFloat;
    dms.qoldiqols_in.AsFloat:=dms.qoldiqkol.AsFloat*dms.qoldiqsena_in_d.AsFloat;
    dms.qoldiqol_all.AsFloat:=dms.qoldiqkol.AsInteger*dms.qoldiqsena_d.AsFloat+dms.qoldiqkol_in.AsInteger*dms.qoldiqsena_in_d.AsFloat;
    dms.qoldiqsot.AsFloat:=dms.qoldiqsotish_d.AsFloat;
    dms.qoldiqsot_in.AsFloat:=dms.qoldiqsotish_in_d.AsFloat;
    dms.qoldiqsot_all.AsFloat:=dms.qoldiqkol.AsInteger*dms.qoldiqsotish_d.AsFloat+dms.qoldiqkol.AsInteger*dms.qoldiqsotish_d.AsFloat;
  end
  else
  begin
    dms.qoldiqol.AsFloat:=dms.qoldiqsena.AsFloat;
    dms.qoldiqol_in.AsFloat:=dms.qoldiqsena_in.AsFloat;
    dms.qoldiqols.AsFloat:=dms.qoldiqkol.AsFloat*dms.qoldiqsena.AsFloat;
    dms.qoldiqols_in.AsFloat:=dms.qoldiqkol.AsFloat*dms.qoldiqsena_in.AsFloat;
    dms.qoldiqol_all.AsFloat:=dms.qoldiqkol.AsInteger*dms.qoldiqsena.AsFloat+dms.qoldiqkol_in.AsInteger*dms.qoldiqsena_in.AsFloat;
    dms.qoldiqsot.AsFloat:=dms.qoldiqsotish.AsFloat;
    dms.qoldiqsot_in.AsFloat:=dms.qoldiqsotish_in.AsFloat;
    dms.qoldiqsot_all.AsFloat:=dms.qoldiqkol.AsInteger*dms.qoldiqsotish.AsFloat+dms.qoldiqkol.AsInteger*dms.qoldiqsotish_in.AsFloat;
  end;

end;

procedure TDMS.asosAfterScroll(DataSet: TDataSet);
begin
  //kassa.g_slave.SumList.RecalcAll;
end;

procedure TDMS.tplBeforePost(DataSet: TDataSet);
begin
  DMS.setup.Refresh;
  ...
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='pl update №';
  ...
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='pl update sana';
  ...
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='pl update sena som';
  ...
  if (tplsena_d.OldValue<>tplsena_d.AsVariant) then begin
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='pl update sena dollar';
  ...
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('nima').AsString:='pl update vid';
  ...
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='pl update srok';
  ...
  DMS.protizm.Insert;
  dms.protizm.fieldbyname('vid').AsInteger:=10;
  dms.protizm.fieldbyname('nima').AsString:='pl update izoh';
