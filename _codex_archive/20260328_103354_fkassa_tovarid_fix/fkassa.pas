...
type
  ...
  public
    { Public declarations }
    procedure EnsureTransportSlaveRow(APostIfCreated: Boolean);
  end;
...
procedure Tkassa.EnsureTransportSlaveRow(APostIfCreated: Boolean);
const
...
begin
  ...
  if dms.asos_slaveturi.AsInteger = 0 then
  begin
    if turi_.ItemIndex = 0 then
      dms.asos_slaveturi.AsInteger := 1
    else
      dms.asos_slaveturi.AsInteger := 0;
  end;
  ...
  if vCreated and APostIfCreated then
    dms.asos_slave.Post;
end;
